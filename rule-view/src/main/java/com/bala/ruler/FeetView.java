...
public class FeetView extends View {
    ...
    /**
     * 最小数值，放大10倍：minValue * 12
     */
    private int mMinNumber;
    /**
     * 最大数值，放大10倍：maxValue * 12
     */
    ...
    public FeetView(Context context) {
        this(context, null);
    }

    public FeetView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public FeetView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        numberPerCount = ta.getInt(R.styleable.RuleView_gv_numberPerCount, 12);
        gradationGap = ta.getDimension(R.styleable.RuleView_gv_gradationGap, dp2px(12));
    ...
    private void convertValue2Number() {
        mMinNumber = (int) (minValue * 12);
        mMaxNumber = (int) (maxValue * 12);
        mCurrentNumber = (int) (currentValue * 12);
        mNumberUnit = (int) (gradationUnit * 12);
    ...
    private void calculateValue() {
        ...
        int feet = mCurrentNumber / 12;
        int inches = mCurrentNumber % 12;
        String result = feet + "." + inches;
        currentValue = Float.parseFloat(result);
    ...
    public void setCurrentValue(float currentValue) {
        ...
        mCurrentNumber = (int) (this.currentValue * 12);
